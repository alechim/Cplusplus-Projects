/**
 * Alec Him, 2001543593, CS 202 1004, Assignment 3
 * Description: Battle Simulation Game with Color-Based Combat Mechanics
 * Input: None
 * Output: Combat results, player status, individual player logs
 */
#include <iostream>
